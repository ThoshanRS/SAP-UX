sap.ui.define(
  ...
  function (Control, Button, Image, Link, Text) {
    ...
    var MovieCard = Control.extend("sample.controls.MovieCard", {
      // the control API:
      metadata: {
        properties: {
          ...
          price: { type: "float" },
          currencyCode: {
            // type: "sample.controls.CurrencyCode",
            defaultValue: "USD",
    ...
    //overwrite setter
    sample.controls.MovieCard.prototype.setCoverPictureUrl = function (sVal) {
      if (sVal) {
    ...
    sample.controls.MovieCard.prototype.exit = function () {
